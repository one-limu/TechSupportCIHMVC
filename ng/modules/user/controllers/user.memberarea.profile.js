angular.module("user").controller('userProfileMemberarea', function($stateParams,$rootScope,$location,$window,userService,$filter,Upload, userService,$timeout,$mdDialog,my_utility,my_session_thing) {
	var vm = this
	console.log('lol')
