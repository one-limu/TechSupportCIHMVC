angular.module("user").controller('userAdminSettingProfile', function(userSession,$state,$rootScope,$location,$window,userService,$filter,Upload, ticketService,$timeout,$mdDialog,my_utility,my_session_thing) {
	var vm = this
	console.log('lol')
	...
	vm.fetch = function(){
          ...
          //  my_session_thing.get_user_info({cct:6}).then(function(respone){
              ...
              vm.userdata = userSession.user
              vm.user_id = vm.userdata.id
              vm.tanggal_lahir = new Date(vm.userdata.birth_date * 1000)
              vm.edit = {
              	id: vm.userdata.id,
