angular.module("user").controller('userAdminLog', function($interval, userSession, $localStorage, $scope, logService, $state, $anchorScroll, $rootScope, $location, $window, userService, $filter, Upload, ticketService, $timeout, $mdDialog, my_utility, my_session_thing) {
    var vm = this
    ...
    */
    ...
    vm._fetch_log = function(resetPage = true) {
        ...
        logService.get_log(vm._filter).then(function(respone) {
            vm.log = respone.data.log.list
            var _ = respone.data.log.pagination
