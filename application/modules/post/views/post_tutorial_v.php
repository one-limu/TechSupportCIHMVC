		...
		<div class="panel panel-primary" style="border: medium none;">
		        ...
		        <div class="panel-body">
                    ...
                    <div class="row post-content">
                        <div class="col-md-3">
                            <a href="#">
                                <img src="<?=base_url('assets/frontend/post/img/900x300.png')?>" alt="" class="img-responsive">
                            </a>
                        </div>
                        <div class="col-md-9">
                            <p>
