  ...
  <div id="div-forms">
                    ...
                    <form id="login-form" action="<?=base_url('user/login')?>" method="post">
		                <div class="modal-body">
				    		...
				    		<input id="login_username" class="form-control" type="text" name="identity" placeholder="Username " required>
				        ...
				        <div class="modal-footer">
                            <div>
                                <button type="submit" class="btn  btn-lg btn-block green-btn">Login</button>
                            </div>
				    	    <div>
